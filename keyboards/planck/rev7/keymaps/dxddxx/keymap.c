...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LSFT_T(KC_Z),   KC_X,    KC_C,    LT(1,KC_V),   KC_B,    KC_N,    LT(2,KC_M),   KC_COMM, KC_DOT,  RSFT_T(KC_SLSH), KC_P3,   KC_P4,
    ...
    [2] = LAYOUT_ortho_4x12
        ...
        KC_LSFT, KC_DEL,  KC_TAB,       KC_BRMD, MS_WHLL, MS_WHLR,      TG(3),   KC_LBRC, KC_RBRC, RSFT_T(KC_BSLS), _______, _______,
        _______, _______, _______,      _______, _______, _______,      _______, _______, _______,        _______,  _______, _______
        ),
    [3] = LAYOUT_ortho_4x12
        (
        ...
        KC_LSFT, KC_BSPC, KC_CAPS,      KC_VOLD, MS_WHLD, MS_WHLR,      TG(3),   KC_LBRC, KC_RBRC, RSFT_T(KC_BSLS), _______, _______,
        _______, _______, _______,      _______, _______, _______,      _______, _______, _______,        _______,  _______, _______
        ),
    [4] = LAYOUT_ortho_4x12
        (
